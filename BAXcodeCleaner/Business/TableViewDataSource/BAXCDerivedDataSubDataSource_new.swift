...
public class BAXCDerivedDataSubDataSource_new: BAXCTableViewSubDataSource_new {
    ...
    public override func setContent(for cell: NSTableCellView, row: Int, column: Int) {
        ...
        if column == 0 {
            ...
            super.setContent(for: cell, row: row, column: column)
        }
    }
...
extension BAXCDerivedDataSubDataSource_new {
