...
public class BAXCTableViewSubDataSource_new: NSObject {
    ...
    public func totalHeight() -> CGFloat {
        ...
        for row in 0..<self.numberOfRows() {
            result = result + self.height(for: row)
        }
...
extension BAXCTableViewSubDataSource_new: BAXCSectionTitleCellDelegate {
...
extension BAXCTableViewSubDataSource_new: BAXCCheckBoxCellDelegate {
...
extension BAXCTableViewSubDataSource_new: BAXCSectionCheckBoxCellDelegate {
