...
class BAXCManualCleanVC_new: BAViewController {
    ...
    private lazy var _dataSource: BAXCTableViewDataSource_new = {
        let result: BAXCTableViewDataSource_new = BAXCTableViewDataSource_new()
        result.delegate = self
        return result
    }()
...
extension BAXCManualCleanVC_new: NSTableViewDelegate {
...
extension BAXCManualCleanVC_new: NSTableViewDataSource {
...
extension BAXCManualCleanVC_new: BAXCTableViewDataSourceProtocol_new {
    func onDatasChanged() {
...
// MARK: - UI setting
extension BAXCManualCleanVC_new {
...
extension BAXCManualCleanVC_new: BAXCNestedTableCellDelegate {
